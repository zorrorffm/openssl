...
bn_mul8x_mont_neon:
	...
	zip1	$Bi.4h,$Bi.4h,$zero.4h

	umull	@ACC[0].2d,$Bi.2s,$A0.s[0]
	umull	@ACC[1].2d,$Bi.2s,$A0.s[1]
	umull	@ACC[2].2d,$Bi.2s,$A0.s[2]
	shl	$Ni.2d,@ACC[0].2d,#16
	ext	$Ni.16b,$Ni.16b,$Ni.16b,#8
	umull	@ACC[3].2d,$Bi.2s,$A0.s[3]

	add	$Ni.2d,$Ni.2d,@ACC[0].2d
	eor	$zero.16b,$zero.16b,$zero.16b
	mul	$Ni.2s,$Ni.2s,$M0.2s

	umull	@ACC[4].2d,$Bi.2s,$A1.s[0]
	ld1	{$N0.4s,$N1.4s}, [$nptr],#32
	umull	@ACC[5].2d,$Bi.2s,$A1.s[1]
	umull	@ACC[6].2d,$Bi.2s,$A1.s[2]
	zip1	$Ni.4h,$Ni.4h,$zero.4h
	umull	@ACC[7].2d,$Bi.2s,$A1.s[3]
	...
	mov	@ACC[0].16b,@ACC[1].16b
	umlal	@ACC[6].2d,$Ni.2s,$N1.s[2]
	mov	@ACC[1].16b,@ACC[2].16b
	umlal	@ACC[7].2d,$Ni.2s,$N1.s[3]
	mov	@ACC[2].16b,@ACC[3].16b
	mov	@ACC[3].16b,@ACC[4].16b
	ushr	$temp.2d,$Temp.2d,#16
	mov	@ACC[4].16b,@ACC[5].16b
	mov	@ACC[5].16b,@ACC[6].16b
	ext	$Temp.16b,$Temp.16b,$Temp.16b,#8
	add	$temp.2d,$temp.2d,$Temp.2d
	mov	@ACC[6].16b,@ACC[7].16b
...
.LNEON_outer8:
	...
	add	$tinptr,sp,#96
	ushr	$temp.2d,$Temp.2d,#16
	zip1	@ACC[0].8h,$Temp.8h,@ACC[0].8h
